...
find ${INPUT_DIR} -name '*.jpg' -exec python3.6 resize_and_compress.py  --input_path {} --output_path {}_w${WIDTH}_h${HEIGHT}_cr${COMPRESSION_RATE}.jpg  --cr ${COMPRESSION_RATE} --width ${WIDTH} --height ${HEIGHT} \;
